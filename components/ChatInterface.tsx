...
function ChatInterface({chatId, initialMessages}:ChatInterfaceProps){
    ...
    const handleSubmit =async(e:React.FormEvent)=>{
        ...
        console.log('Entered inside here')
e.preventDefault()
...
console.log("optimistic user messages:", optimisticUserMessage)
setMessages((prev)=> [...prev, optimisticUserMessage])


console.log("messages ", messages)
// Track complete respnse for saving in databse
let fullResponse = "";
...
console.log("response", response)
                ...
                case StreamMessageType.ToolStart:
                    ...
                    case StreamMessageType.ToolEnd:
                        ...
                        case StreamMessageType.Error:
                            ...
                            // Savve thecommple message to the database
    ...
    [0, 0.2, 0.4].map((delay, i) => (
        <div
            key={i}
            className="h-2 w-2 rounded-full bg-gray-400 animate-bounce-smooth"
